...
def main():
    ...
    print(args)
    #get flags
    #turn this if statement to work correclty under parser
    if len(args) < 1:
        print("No Flags! Type -h for help: " +
              "pyCompress will compress all images in this " +
              "dir with \n Max Dimension: 400px Verbose: Flase")
